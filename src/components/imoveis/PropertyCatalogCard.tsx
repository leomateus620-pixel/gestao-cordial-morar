...
export function PropertyCatalogCard({ property }: { property: Property }) {
  ...
  const specs = [
    property.dormitorios !== null ? { icon: Bed, text: `${property.dormitorios} dorm.` } : null,
  ...
  return (
    <div
      className="group relative overflow-hidden rounded-3xl transition-all duration-200 hover:-translate-y-0.5 hover:shadow-xl focus-within:ring-2 focus-within:ring-primary/40"
      style={{
        background:
    ...
    >
        ...
        <div className="flex gap-3 p-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-2 flex flex-wrap items-end justify-between gap-2">
              ...
              <p className="shrink-0 pr-9 font-mono text-sm font-bold text-primary">
      ...
      <Link
        ...
        className="absolute bottom-3 right-3 grid size-8 place-items-center rounded-full bg-white/75 text-foreground/60 opacity-0 transition group-hover:opacity-100 focus:opacity-100 hover:text-primary"
      >
