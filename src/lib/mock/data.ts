...
export const dashboardEvolucaoMensal = [
  { mes: "Jan", cordial: 32, morar: 24, total: 56 },
  { mes: "Fev", cordial: 38, morar: 29, total: 67 },
  { mes: "Mar", cordial: 35, morar: 31, total: 66 },
  { mes: "Abr", cordial: 44, morar: 36, total: 80 },
  { mes: "Mai", cordial: 51, morar: 42, total: 93 },
  { mes: "Jun", cordial: 58, morar: 46, total: 104 },
];

export const dashboardOrigemLeads = [
  { origem: "WhatsApp", cordial: 42, morar: 34, total: 76 },
  { origem: "Portal", cordial: 30, morar: 26, total: 56 },
  { origem: "Indicação", cordial: 18, morar: 16, total: 34 },
  { origem: "Instagram", cordial: 14, morar: 12, total: 26 },
  { origem: "Placa", cordial: 8, morar: 7, total: 15 },
];

export const dashboardAluguelVenda = [
  { mes: "Jan", aluguel: 14, venda: 28 },
  { mes: "Fev", aluguel: 18, venda: 35 },
  { mes: "Mar", aluguel: 16, venda: 22 },
  { mes: "Abr", aluguel: 22, venda: 48 },
  { mes: "Mai", aluguel: 24, venda: 62 },
  { mes: "Jun", aluguel: 28, venda: 84 },
];

export const dashboardPrevisaoFinanceira = [
  { mes: "Jan", receita: 148000, comissao: 42000, aberto: 18000 },
  { mes: "Fev", receita: 176000, comissao: 51000, aberto: 22000 },
  { mes: "Mar", receita: 161000, comissao: 47000, aberto: 19000 },
  { mes: "Abr", receita: 226000, comissao: 66000, aberto: 24000 },
  { mes: "Mai", receita: 284000, comissao: 83000, aberto: 27000 },
  { mes: "Jun", receita: 336000, comissao: 98000, aberto: 32500 },
];
...
export const dashboardDesempenhoCorretores = [
  ...
  { nome: "Felipe", atendimentos: 14, contratos: 3, comissao: 9200, imobiliaria: "morar" as const },
  {
    nome: "Camila",
    atendimentos: 19,
    contratos: 5,
    comissao: 14800,
    imobiliaria: "morar" as const,
  },
];
...
export const dashboardComparativoCordialMorar = [
  {
    ...
    alugueis: 17,
    vendas: 9,
    receitaPrevista: 186000,
    conversao: 23,
    origemContatos: "WhatsApp 38%, Portal 27%, Indicação 16%",
  },
  {
    imobiliaria: "Morar",
    atendimentos: 95,
    alugueis: 14,
    vendas: 7,
    receitaPrevista: 150000,
    conversao: 22,
    origemContatos: "WhatsApp 36%, Portal 28%, Indicação 17%",
  },
];
